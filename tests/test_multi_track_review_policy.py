...
class MultiTrackReviewPolicyTests(unittest.TestCase):
    def setUp(self):
        self.policy = json.loads(
            (ROOT / "agents/openrouter-paid-review-policy.json").read_text(encoding="utf-8")
        )
    ...
    def test_matrix_spans_design_and_operational_work(self):
        ...
        required = {
            "canonical_design",
            "operations_and_budget",
            "test_and_verification",
            "integration_and_provenance",
            "security_and_privacy",
            "authority_and_actiongate",
        }
    ...
    def test_specialist_sweep_is_free_only_and_broad(self):
        ...
        self.assertGreaterEqual(
            cfg["max_free_calls_per_hour"],
            cfg["preferred_families_per_hour"] * 2,
        )
